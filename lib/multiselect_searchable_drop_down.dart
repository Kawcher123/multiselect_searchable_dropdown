...
class MultiSelectSearchableDropdown extends StatefulWidget {
  ...
  const MultiSelectSearchableDropdown.simpleList({
    super.key,
    required this.list,
    required this.initiallySelected,
    required this.onChange,
  ...
  @override
  State<MultiSelectSearchableDropdown> createState() => _MultiSelectSearchableDropdownState();
}
      ...
      builder: (ctx, boxConstraints) {
        ...
        return ConstrainedBox(
          ...
          child: MenuAnchor(
            ...
            // alignmentOffset: Offset(0, 1),
            style: MenuStyle(
              fixedSize: MaterialStateProperty.resolveWith((states) {
                return Size(size.width*0.935, modalHeight);
              },
